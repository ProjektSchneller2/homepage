...
if ($ergebnis){
	...
	echo "<tr><td><b>CSR-Typ</b></td><td><b>User</b></td><td><b>Laufzeit</b></td><td><b>Timestamp</b></td><td><b>CSR-Pfad</b></td><td><b>CSR pr�fen</b></td></tr>";
	while ($zeile = mysqli_fetch_array($ergebnis, MYSQL_ASSOC))
		{
				...
				echo "<td> <input type=\"submit\" value=\"CSR pr�fen\"></td>";
				echo "</form>";
				echo "</tr>";
			}
	echo "</table>";
